...
---
> (1-1) GRBE - E task
Opção da chamada : tra dados da transaçãocom dados da área de comunicação grbe-aplicação ( lparam4 ) ter dados do terminalgmt horário gmtbrancos dados do
...
MENOR - Do que o tamanho da 4ª área , que é copiada etruncada de acordo com o tamanho especificado pela aplicação .
Foi solicitado opção `` com '' e o tamanho passadopela aplicação é

> (3-1) Processamento normal .
MAIOR - Do que o tamanho da 4ª área , que é copiada como seu tamanho correto
Foi solicitado opção `` com '' e o tamanho passadopela aplicação é
Observação
