...
> (2-1): Processamento Normal. Foi solicitado opção "COM" e o tamanho passadopela aplicação é MENOR do que o tamanho da 4ª área,
> que é copiada etruncada de acordo com o tamanho especificado pela aplicação.
> (3-1): Processamento Normal. Foi solicitado opção "COM" e o tamanho passadopela aplicação é MAIOR do que o tamanho da 4ª área,
> que é copiada como seu tamanho correto
Observação
